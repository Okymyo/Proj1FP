...
def categoria(numero): #M
    ...
    if 1 <= int(numero[0]) <= 9: 
        ...
        categorias = ('Companhias aereas',
                      ...
                      'Saude, telecomunicacoes e outras atribuicoes futuras\
 da industria','Atribuicao nacional') 
        
        # A primeira posicao do tuplo corresponde ao zero.
        # Subtrai-se 1 ao 1o digito para obtermos a correspondencia correta:
